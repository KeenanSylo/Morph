    ...
    <main className="relative h-screen w-full overflow-hidden text-white selection:bg-orange-500/30">
      ...
      <div className="relative z-30 h-full flex flex-col items-center justify-center text-center px-4">
        ...
        <p className="text-lg md:text-xl text-neutral-400 max-w-xl mb-10 leading-relaxed font-light animate-fade-in-up opacity-0 [animation-delay:600ms] [animation-fill-mode:forwards]">
          The open-source generative design studio. Now featuring Blobs, Gradients, Waves, and 3D Grids.
        </p>
        ...
        <div className="animate-fade-in-up opacity-0 [animation-delay:800ms] [animation-fill-mode:forwards]">
            <button
              ...
              className="group relative px-10 py-5 bg-orange-600 hover:bg-orange-500 text-white rounded-full font-semibold text-lg tracking-tight transition-all hover:scale-105 hover:shadow-2xl hover:shadow-orange-600/20 flex items-center gap-3"
            >
              Explore Studio
